...
// On importe le middleware like-config pour la gestion des likes
const like = require('../middleware/like-config');
...
router.post('/:id/like', auth, like, saucesCtrl.likeOneSauce);
