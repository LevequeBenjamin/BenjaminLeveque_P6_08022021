...
// Il doit contenir entre 3 et 30 caratères
// Regex pour restreindre le type de symboles utilisables
...
// Le principal ingrédient doit contenir entre 3 et 20 caractères
// Regex pour restreindre le type de symboles utilisables
exports.ingredientValidator = [ 
  ...
  validate({
    validator: 'matches',
    arguments: /^[a-z\d\-_\s]+$/i, 
    message: "Vous ne pouvez utiliser que des chiffres et des lettres pour les ingrédients",
  }),
];
